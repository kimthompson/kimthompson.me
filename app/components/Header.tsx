...
export default function Header() {
  ...
  return (
    ...
    <div className="flex-auto max-w-sm md:max-w-md lg:max-w-2xl">
      ...
      <p className="text-gray-900 dark:text-slate-100">Web (<a className="text-indigo-500 hover:text-gray-900 dark:hover:text-slate-100" href="/assets/resume.pdf">+ more</a>) developer. {randomPhrase}</p>
    </div>
